...
var ComboBoxInternal = /** @class */ (function (_super) {
    ...
    function ComboBoxInternal(props) {
        ...
        _this._onRenderList = function (props) {
            var onRenderItem = props.onRenderItem, options = props.options, label = props.label;
            var id = _this._id;
            return (React.createElement("div", { id: id + '-list', className: _this._classNames.optionsContainer, "aria-labelledby": label && id + '-label', role: "listbox" }, options.map(function (item) { return onRenderItem === null || onRenderItem === void 0 ? void 0 : onRenderItem(item, _this._onRenderItem); })));
        };
        // Render items
